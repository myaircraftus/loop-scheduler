...
describe("next.config.js - Org Rewrite", () => {
  describe("getRegExpThatMatchesAllOrgDomains", () => {
    ...
    it("Vercel Preview special handling - vercel.app. Loop Customer Booking deployed on vercel apps have different subdomains, so we can't consider them org domains", () => {
