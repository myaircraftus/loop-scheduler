...
export const metadata: Metadata = {
  title: "Loop Customer Booking referral program - Earn money by sharing your link",
  description:
    "Earn 20% recurring commissions for a full year by referring others to Loop Customer Booking, while giving your referrals 20% off for 12 months. Share your link and start earning today!",
};
